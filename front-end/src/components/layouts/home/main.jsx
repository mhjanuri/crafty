...
class Fashion extends Component {
	...
	render() {
		...
		return (
			<div>
                <Helmet>
                    <title>Crafty - E-commerce for Handicraft and Arts</title>
                    <meta name="description" content="Crafty - E-commerce for Handicraft and Arts." />
                </Helmet>
                {/*Home Slider*/}
                                        ...
                                        <div className="col">
                                            <div className="slider-contain">
                                                {/* <div>
                                                    ...
                                                    <h1>men fashion</h1>
                                                    <Link to={`${process.env.PUBLIC_URL}/collection`} className="btn btn-solid">shop now</Link>
                                                </div> */}
                                            </div>
                                        </div>
                                    </div>
