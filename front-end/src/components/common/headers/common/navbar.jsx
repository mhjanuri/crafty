                ...
                <div className="main-navbar">
                    <div id="mainnav" >
                        ...
                        <ul className="nav-menu" style={this.state.navClose}>
                            ...
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/collection`} className="nav-link" onClick={(e) => this.handleSubmenu(e)}>
                                    {translate('shop')}
                                </Link>
                                
                            </li>
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/about-us`} className="nav-link" onClick={(e) => this.handleSubmenu(e)}>
                                    {translate('about_us')}
                                </Link>
                            </li>
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/blog`} className="nav-link" onClick={(e) => this.handleSubmenu(e)}>
                                    {translate('blog')}
                                </Link>
                            </li>
                        </ul>
