...
import { getProductsData, changeCurrency } from '../../../actions'
...
class HeaderOne extends Component {
	...
	componentDidMount() {
		...
		.then((res)=>{
			...
			this.props.getProductsData(res.data)
		}).catch((err)=>{
			console.log(err);
													...
													<li className="onhover-div mobile-setting">
														...
														<div className="show-div setting">
															...
															<ul className="list-inline">
																<li><a href={null} onClick={() => this.props.changeCurrency('Rp ')}>IDR Rupiah</a> </li>
																<li><a href={null} onClick={() => this.props.changeCurrency('$ ')}>USD Dollar</a> </li>
															</ul>
														</div>
													</li>
...
export default connect(null,
	{ getProductsData, changeCurrency }
)(HeaderOne);