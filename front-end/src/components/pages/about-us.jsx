                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-sm-12">
                                <h4>Crafty is an E-commerce for Handicraft and Arts</h4>
                                <p>We are so good, that we put lorem ipsum below</p>
                                <p>Lorem ipsum Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium On the other hand, we denounce with righteous indignation and dislike men who are so
